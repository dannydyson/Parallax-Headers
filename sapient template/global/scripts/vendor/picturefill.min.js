window.matchMedia || (window.matchMedia = function() {
    ...
    function c(a) {
        ...
        f = void 0, g = void 0, h = void 0, c[e.ns] || (c[e.ns] = {}), a.reevaluate || !c[e.ns].evaluated) {
            ...
            (void 0 === h.srcset || h.getAttribute("sizes")) && e.applyBestCandidate(g, h)), 
            c[e.ns].evaluated = !0);
        }
    }
    function d() {
    ...
    if (!a.HTMLPictureElement) {
        ...
        }, e.types = {}, e.types["image/svg+xml"] = b.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Image", "1.1"), 
